...
--openpose_only --input_nc 3 --n_scales_spatial 2 --ngf 64 --num_D 3 \
--resize_or_crop randomScaleHeight_and_scaledCrop --loadSize 768 --fineSize 512 --display_winsize 512 \
