...
--openpose_only --input_nc 3 --n_scales_spatial 3 --num_D 4 --ngf 64 --ndf 32 \
--resize_or_crop randomScaleHeight_and_scaledCrop --loadSize 1536 --fineSize 1024 --display_winsize 1024 \
